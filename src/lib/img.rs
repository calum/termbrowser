...
pub fn print_image(img: image::DynamicImage, true_colour: bool, width: u32, height: u32) -> String {
    let mut image_as_text = String::new();
    ...
    if !true_colour {
        ...
        for y in 0..height {
            ...
            for x in 0..width {
                ...
                image_as_text.push(format!(row, "\x1b[48;2;{};{};{}m\x1b[38;2;{};{};{}m▄",
                       top[0], top[1], top[2],
                       bottom[0], bottom[1], bottom[2]).unwrap());
            }

            image_as_text.push(format!(row, "\x1b[m\n").unwrap());
            row.clear();
        }
    }
    image_as_text
